...
from .resnetv3 import resnetV8x4, resnetV32x4
...
cifar_model_dict = {
    ...
    "resnetV32x4": (resnetV32x4, cifar100_model_prefix+"resnetV32x4_vanilla/ckpt_epoch_240.pth"),
    # students
