...
class ConvNeXt(nn.Module):
    ...
    def forward_features(self, x):
        ...
        feats["pooled_feat"] = x
        feats["preact_feats"] = [feats["feats"][0], feats["feats"][1], feats["feats"][2], feats["feats"][3], feats["feats"][4]]
        feats["feats"] = [
            F.relu(feats["feats"][0]),
            F.relu(feats["feats"][1]),
            F.relu(feats["feats"][2]),
            F.relu(feats["feats"][3]),
            F.relu(feats["feats"][4]),
        ]
